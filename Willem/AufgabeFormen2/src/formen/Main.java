...
//		CopyFiles.writeFile(TestClass.getTestDaten()); 
		
//		TestClass.createBinary("blub", TestClass.getRandomDaten(5, 100));
//		ArrayList<Punkt> testErgebnis = TestClass.readBinary("blub");
//		System.out.println(testErgebnis);
		
		TestClass.fullProcess("blub");
	}
